...
// Find the line index for `  return (` starting from bottom
...
const topPart = lines.slice(0, returnLineIndex).join('\n') + '\n' + statsMemo + '\n';
...
fs.writeFileSync(filePath, topPart + newJSX, 'utf8');
console.log('Successfully applied correct simplified file content');
